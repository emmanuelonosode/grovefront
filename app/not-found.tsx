    ...
    <main className="min-h-screen bg-[#F4ECDC] flex flex-col items-center justify-center px-6 pt-20 pb-16 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 bg-[#0052FF] text-white text-sm font-semibold px-7 py-3.5 rounded-sm hover:bg-[#0041D6] transition-colors"
        >
          Browse Homes
        </Link>
        <Link
          href="/contact"
          className="inline-flex items-center justify-center gap-2 border border-[#0052FF]/20 text-[#0052FF] text-sm font-semibold px-7 py-3.5 rounded-sm hover:bg-[#0052FF]/5 transition-colors"
        >
          Get in Touch
        </Link>
      </div>
