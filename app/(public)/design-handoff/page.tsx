...
const colors = [
  { name: "Brand Blue",  hex: "#012d1d", use: "CTAs · Links · Accents",        dark: false },
  { name: "Ink Navy",    hex: "#081C15", use: "Headers · Dark backgrounds",     dark: true  },
  ...
  { name: "Muted Blue",  hex: "#c1ecd4", use: "Badges · Tags · Chips",          dark: false },
