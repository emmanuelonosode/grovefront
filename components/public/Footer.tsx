...
const footerCols = [
  {
    ...
    links: [
      ...
      { label: "Pet-friendly houses",  href: "/houses-for-rent?pets=true" },
      { label: "All cities",           href: "/#all-cities" },
    ],
  },
  {
    h: "Apply",
    links: [
      ...
      { label: "Resident log in",      href: "/login" },
...
export async function Footer() {
  ...
  return (
    <footer style={{ background: "#081C15", color: "rgba(255,255,255,0.7)" }}>
      {/* Main columns */}
      <div className="max-w-7xl mx-auto px-8 pt-14 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_repeat(4,1fr)] gap-10">
          ...
          <div>
            ...
            <p className="mt-4 leading-[1.6]" style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 14, color: "rgba(255,255,255,0.7)", maxWidth: 240 }}>
              Good Homes. Fair Prices. No Surprises.<br />Housing 2,000+ families across the U.S. since 2012.
            </p>
            <p className="mt-3" style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 14, color: "rgba(255,255,255,0.7)" }}>
            ...
            <Link
              ...
              style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 14, color: "rgba(255,255,255,0.75)" }}
            >
              Contact us →
            </Link>
            <div className="flex gap-2.5 mt-5">
              {[
                { href: BUSINESS.sameAs[0], label: "Facebook",  Icon: FacebookIcon },
                { href: BUSINESS.sameAs[1], label: "TikTok",    Icon: TikTokIcon },
                { href: BUSINESS.sameAs[2], label: "Instagram", Icon: InstagramIcon },
                ...
                <a
                  ...
                  aria-label={`${BUSINESS.displayName} on ${label}`}
                  className="w-8 h-8 rounded-full flex items-center justify-center transition-colors border border-white/10 text-white/70 hover:text-earth-beige hover:border-earth-beige"
                >
                  <Icon />
                </a>
              ))}
            ...
            <div key={col.h}>
              ...
              {col.links.map((link) => (
                <Link
                  ...
                  style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 14.5, color: "rgba(255,255,255,0.75)", textDecoration: "none" }}
                >
                  {link.label}
                </Link>
              ))}
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="max-w-7xl mx-auto px-8 py-7">
          ...
          <p style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 12.5, color: "rgba(255,255,255,0.62)", lineHeight: 1.65, maxWidth: "56rem" }}>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="max-w-7xl mx-auto px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 12.5, color: "rgba(255,255,255,0.62)" }}>
            © {new Date().getFullYear()} {BUSINESS.displayName} · Equal Housing Opportunity
          </div>
          <div className="flex gap-[18px]">
            {[
              ...
              <Link
                key={l.label}
                href={l.href}
                style={{ fontFamily: "var(--font-source-sans), sans-serif", fontSize: 12.5, color: "rgba(255,255,255,0.65)", textDecoration: "none" }}
