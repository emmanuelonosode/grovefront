...
export const CITIES: Record<string, CityData> = {
  ...
  "tampa-fl": {
    ...
    state: "Florida",
    stateCode: "FL",
    tagline: "Bay Area living with sunshine, culture, and coastal charm.",
    heroImage: "/images/states/florida/tampa-waterfront-skyline.jpg",
    avgRent: "$1,250",
...
export function buildGenericCityData(stats: CityStats): CityData {
  ...
  return {
    ...
    tagline: pickVariant([
      `Houses for rent in ${stats.city}, ${stateName}.`,
